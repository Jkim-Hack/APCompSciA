...
public class Trail {
	 ...
	 * 
	 * @param start
	 *            the index of the starting marker
	 * @param end
	 *            the index of the ending marker Precondition: 0 <= start < end <=
	 *            markers.length - 1
	 ...
	 * 
	 * @param start
	 *            the index of the marker to start from.
	 * @param end
	 *            the index of the marker to end at.
	 * @return the maximum elevation of the section of trail.
	 */
	// JOHN
	public int findMaxElevation(int start, int end) {
		int elevation = markers[start];
